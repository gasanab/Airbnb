...
bookingsRouter.use(generalLimiter);
 ...
 */
bookingsRouter.get("/users/:id/bookings", getUserBookings);
 ...
 */
bookingsRouter.post("/", strictLimiter, authenticate, requireGuest, validate(createBookingSchema), createBooking);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
bookingsRouter.patch("/:id/status", authenticate, validate(updateBookingStatusSchema), updateBookingStatus);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
bookingsRouter.delete("/:id", authenticate, validate(deleteBookingSchema), deleteBooking);
