 ...
 */
usersRouter.get("/:id", authenticate, validate(getUserByIdSchema), getUserById);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
usersRouter.get("/:id/listings", authenticate, validate(getUserListingsSchema), getUserListings);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
usersRouter.get("/:id/bookings", authenticate, validate(getUserBookingsSchema), getUserBookings);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
usersRouter.post("/", authenticate, requireAdmin, validate(createUserSchema), createUser);
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
usersRouter.delete("/:id", authenticate, requireAdmin, validate(deleteUserSchema), deleteUser);
