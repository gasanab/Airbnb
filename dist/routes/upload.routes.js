 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
uploadRouter.post("/users/:id/avatar", auth_middleware_1.authenticate, multer_1.upload.single("image"), upload_controller_1.uploadAvatar);
/**
 * @swagger
 * /users/{id}/avatar:
 *   delete:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
uploadRouter.delete("/users/:id/avatar", auth_middleware_1.authenticate, upload_controller_1.deleteAvatar);
/**
 * @swagger
 * /listings/{id}/photos:
 *   post:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
uploadRouter.post("/listings/:id/photos", auth_middleware_1.authenticate, multer_1.upload.array("photos", 5), upload_controller_1.uploadListingPhotos);
/**
 * @swagger
 ...
 */
uploadRouter.delete("/listings/:id/photos/:photoId", auth_middleware_1.authenticate, upload_controller_1.deleteListingPhoto);
