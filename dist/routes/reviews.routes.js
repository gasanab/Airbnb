...
reviewsRouter.use(rateLimiter_1.generalLimiter);
/**
 * @swagger
 * /listings/{id}/reviews:
 *   get:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
reviewsRouter.post("/listings/:id/reviews", rateLimiter_1.strictLimiter, auth_middleware_1.authenticate, reviews_controller_1.createReview);
/**
 * @swagger
 * /reviews/{id}:
 *   delete:
