...
const createReview = async (req, res) => {
    try {
        ...
        (0, cache_1.deleteCacheByPrefix)(`reviews:listing:${listingId}`);
        ...
        (0, error_handler_1.handleControllerError)(error, res, "reviews.createReview");
    }
};
...
const getListingReviews = async (req, res) => {
    try {
        ...
        // Generate cache key
        const cacheKey = (0, cache_1.generateCacheKey)(`reviews:listing:${listingId}`, { page, limit });
        // Check cache first
        ...
        (0, error_handler_1.handleControllerError)(error, res, "reviews.getListingReviews");
    }
};
...
const deleteReview = async (req, res) => {
    try {
        ...
        // Clear cache for this listing's reviews
        (0, cache_1.deleteCacheByPrefix)(`reviews:listing:${review.listingId}`);
        ...
        (0, error_handler_1.handleControllerError)(error, res, "reviews.deleteReview");
    }
};
